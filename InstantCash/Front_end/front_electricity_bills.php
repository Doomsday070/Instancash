...
<body>
    ...
    <?php } ?>
    <form action="electricity_bills.php" method="POST">
        ...
        <select id="organization_id" name="organization_id" onchange="updateOrganizationName()" required>
            ...
            <option value="444" <?php echo ($organization_id == '444') ? 'selected' : ''; ?>>444 - DPDC</option>
            <option value="445" <?php echo ($organization_id == '445') ? 'selected' : ''; ?>>445 - DESCO</option>
            <option value="446" <?php echo ($organization_id == '446') ? 'selected' : ''; ?>>446 - Palli Bidyut</option>
            <option value="447" <?php echo ($organization_id == '447') ? 'selected' : ''; ?>>447 - BPDB</option>
        </select>
        <input type="hidden" id="organization_name" name="organization_name">
        <br><br>

        <label for="meter_no">Meter_no:</label>
        <input type="text" id="meter_no" name="meter_no" value="<?php echo htmlspecialchars($meter_no); ?>" required><br><br>
