...
<body>
    ...
    <form action="internet_bills.php" method="POST">
        ...
        <select id="organization_id" name="organization_id" onchange="updateOrganizationName()" required>
            ...
            <option value="333" <?php echo ($organization_id == '333') ? 'selected' : ''; ?>>333 - Bnet</option>
            <option value="334" <?php echo ($organization_id == '334') ? 'selected' : ''; ?>>334 - X-press Technologies</option>
            <option value="335" <?php echo ($organization_id == '335') ? 'selected' : ''; ?>>335 - SamOnline</option>
            <option value="336" <?php echo ($organization_id == '336') ? 'selected' : ''; ?>>336 - Exord Online</option>
        </select>
