...
<body>
    ...
    <?php } ?>
    <form action="gas_bills.php" method="POST">
        ...
        <select id="organization_id" name="organization_id" onchange="updateOrganizationName()" required>
            ...
            <option value="111" <?php echo ($organization_id == '111') ? 'selected' : ''; ?>>111 - Titas Gas Limited</option>
            <option value="112" <?php echo ($organization_id == '112') ? 'selected' : ''; ?>>112 - Karnaphuli Gas Limted</option>
            <option value="113" <?php echo ($organization_id == '113') ? 'selected' : ''; ?>>113 - Petrobangla Gas Limited</option>
            <option value="114" <?php echo ($organization_id == '114') ? 'selected' : ''; ?>>114 - Bakhrabad Gas Limted</option>
        </select>
